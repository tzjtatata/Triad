...
python llava_eval/evaluate.py --model-path $model_path --model-type myriad2 --ds $dataset --data_path $d_path --text_src "config:$v" --subset $prod --from question${expert}.jsonl --to $ans_path  --image_num 1 --qa_mode single_qa
