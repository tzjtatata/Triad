...
class ModelWorker:
    def __init__(self, controller_addr, worker_addr, worker_id, no_register, model_path, model_base, model_name, load_8bit, load_4bit):
        ...
        # self.tokenizer, self.model, self.image_processor, self.context_len = load_pretrained_model(model_path, model_base, self.model_name, load_8bit, load_4bit, overwrite_config={"vocab_size":152064})
    ...
    def generate_stream(self, params):
        ...
        if images is not None and len(images) > 0 and self.is_multimodal:
            if len(images) > 0:
                ...
                images = process_images(images, image_processor, model.config, masks=masks)
