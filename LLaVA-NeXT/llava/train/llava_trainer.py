...
class LLaVATrainer(Trainer):
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if not isinstance(train_dataset, torch.utils.data.IterableDataset):
            ...
            print("Prefetch Factor", self.args.prefetch_factor)
            dataloader_params["prefetch_factor"] = self.args.dataloader_num_workers * self.args.prefetch_factor if self.args.dataloader_num_workers != 0 else None
